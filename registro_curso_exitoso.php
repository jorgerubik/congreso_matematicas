...
if($numero_ponencia <= 9){
	...
	exe_query($query);
	if ($rfc_coautor1 != "") {
		$query="INSERT INTO autores VALUES ('$rfc_coautor1', 'coautor1', 'T09', '".$curso."00".$numero_ponencia."', '$requiere1', '$fecha')";
		exe_query($query);
	}
	if ($rfc_coautor2 != ""){
		$query="INSERT INTO autores VALUES ('$rfc_coautor2', 'coautor2', 'T09', '".$curso."00".$numero_ponencia."', '$requiere2', '$fecha')";
		exe_query($query);
	}
	...
	exe_query($query);
	if ($rfc_coautor1 != "") {
		$query="INSERT INTO autores VALUES ('$rfc_coautor1', 'coautor1', 'T09', '".$curso."0".$numero_ponencia."', '$requiere1', '$fecha')";
		exe_query($query);
	}
	if ($rfc_coautor2 != ""){
		$query="INSERT INTO autores VALUES ('$rfc_coautor2', 'coautor2', 'T09', '".$curso."0".$numero_ponencia."', '$requiere2', '$fecha')";
		exe_query($query);
	}
	...
	exe_query($query);
	if ($rfc_coautor1 != "") {
		$query="INSERT INTO autores VALUES ('$rfc_coautor1', 'coautor1', 'T09', '".$curso.$numero_ponencia."', '$requiere1', '$fecha')";
		exe_query($query);
	}
	if ($rfc_coautor2 != ""){
		$query="INSERT INTO autores VALUES ('$rfc_coautor2', 'coautor2', 'T09', '".$curso.$numero_ponencia."', '$requiere2', '$fecha')";
		exe_query($query);
	}
