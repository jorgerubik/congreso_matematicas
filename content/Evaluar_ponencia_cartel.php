...
<fieldset>
	...
	////////////////////////// FUNCIÓN PARA EJECUTAR QUERY
			...
			$query = "SELECT titulo_cartel, resumen_cartel, referencias_cartel FROM ponencias_cartel WHERE id_ponencia_cartel = '".$id_ponencia."'";
			$r = mysql_query($query);
			if (!$r) {
				echo "No se ejecutó el query: $query <br>";
				trigger_error(mysql_error(), E_USER_ERROR);
				...
				echo "<table cellpadding='15' > <tr><th style='vertical-align: top;' class='font_titulos'>Título:</th><td style='text-align: justify;'>".$row['titulo_cartel']."</td></tr>";
				echo "<tr><th style='vertical-align: top;' class='font_titulos'>Resumen:</th><td style='text-align: justify;'>".$row['resumen_cartel']."</td></tr>";
				echo "<tr><th style='vertical-align: top;' class='font_titulos'>Referencias:</th><td style='text-align: justify;'>".$row['referencias_cartel']."</td></tr>";
				echo "</table>";
			}
...
<fieldset id='observaciones_aceptado' style='display:none;'>
	...
	<form action = 'ponencia_cartel_evaluada.php' method = 'post'>
		<table>
			<tr>
