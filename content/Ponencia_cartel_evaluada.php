...
////////////////////////// FUNCIÓN PARA EJECUTAR QUERY
		...
		$query_info_trabajo = "SELECT titulo_cartel, id_modalidad, id_categoria FROM ponencias_cartel WHERE id_ponencia_cartel = '".$id_trabajo."'";
		...
		if (!$r) {
			...
			$titulo_trabajo = $row_info_trabajo['titulo_cartel'];
		...
		if($evaluacion == "ACEPTADO"){
			$query_registro_evaluacion = "UPDATE ponencias_cartel SET aceptado_resumen_cartel = 'SI', observaciones_cartel = '".$comentario_aceptado."' WHERE id_ponencia_cartel = '".$id_trabajo."'";
			...
			echo "<input type='text' name='tipotrabajo' value='cartel' style='display:none;'/>";
			...
			$query_registro_evaluacion = "UPDATE ponencias_cartel SET aceptado_resumen_cartel = 'NO', observaciones_cartel = '".$comentario_rechazado."' WHERE id_ponencia_cartel = '".$id_trabajo."'";
			$r_registro_evaluacion = mysql_query($query_registro_evaluacion);
			echo "<form action='lista_trabajos.php' method='POST'>";
