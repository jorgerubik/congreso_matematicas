...
////////////////////////// FUNCIÓN PARA EJECUTAR QUERY
		...
		$query_info_trabajo = "SELECT titulo_taller FROM ponencias_taller WHERE id_ponencia_taller = '".$id_trabajo."'";
		...
		if (!$r) {
			...
			$titulo_trabajo = $row_info_trabajo['titulo_taller'];
		...
		if($evaluacion == "ACEPTADO"){
			$query_registro_evaluacion = "UPDATE ponencias_taller SET aceptado_resumen_taller = 'SI', observaciones_taller = '".$comentario_aceptado."' WHERE id_ponencia_taller = '".$id_trabajo."'";
			...
			echo "<input type='text' name='tipotrabajo' value='taller' style='display:none;'/>";
			...
			$query_registro_evaluacion = "UPDATE ponencias_taller SET aceptado_resumen_taller = 'NO', observaciones_taller = '".$comentario_rechazado."' WHERE id_ponencia_taller = '".$id_trabajo."'";
			$r_registro_evaluacion = mysql_query($query_registro_evaluacion);
			echo "<form action='lista_trabajos.php' method='POST'>";
