...
<fieldset>
	...
	////////////////////////// FUNCIÓN PARA EJECUTAR QUERY
			...
			$query = "SELECT titulo_curso, resumen_curso, material_curso FROM ponencias_curso WHERE id_ponencia_curso = '".$id_ponencia."'";
			$r = mysql_query($query);
			if (!$r) {
				echo "No se ejecutó el query: $query <br>";
				trigger_error(mysql_error(), E_USER_ERROR);
				...
				echo "<table cellpadding='15' > <tr><th style='vertical-align: top;' class='font_titulos'>Título:</th><td style='text-align: justify;'>".$row['titulo_curso']."</td></tr>";
				echo "<tr><th style='vertical-align: top;' class='font_titulos'>Resumen:</th><td style='text-align: justify;'>".$row['resumen_curso']."</td></tr>";
				echo "<tr><th style='vertical-align: top;' class='font_titulos'>Materiales:</th><td style='text-align: justify;'>".$row['material_curso']."</td></tr>";
				echo "</table>";
			}
...
<fieldset id='observaciones_aceptado' style='display:none;'>
	...
	<form action = 'ponencia_curso_evaluada.php' method = 'post'>
		<table>
			<tr>
