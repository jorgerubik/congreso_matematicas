...
////////////////////////// FUNCIÓN PARA EJECUTAR QUERY
		...
		$query_info_trabajo = "SELECT titulo_curso FROM ponencias_curso WHERE id_ponencia_curso = '".$id_trabajo."'";
		...
		if (!$r) {
			...
			$titulo_trabajo = $row_info_trabajo['titulo_curso'];
		...
		if($evaluacion == "ACEPTADO"){
			$query_registro_evaluacion = "UPDATE ponencias_curso SET aceptado_resumen_curso = 'SI', observaciones_curso = '".$comentario_aceptado."' WHERE id_ponencia_curso = '".$id_trabajo."'";
			...
			echo "<input type='text' name='tipotrabajo' value='curso' style='display:none;'/>";
			...
			$query_registro_evaluacion = "UPDATE ponencias_curso SET aceptado_resumen_curso = 'NO', observaciones_curso = '".$comentario_rechazado."' WHERE id_ponencia_curso = '".$id_trabajo."'";
			$r_registro_evaluacion = mysql_query($query_registro_evaluacion);
			echo "<form action='lista_trabajos.php' method='POST'>";
