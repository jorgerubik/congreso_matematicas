...
//conectar con el servidor
	$conn = mysql_connect("$host", "$user", "$pass");
		...
		$r = mysql_query($query);
					...
					echo "<form action = 'registro_curso_verifica.php' method='post'><fieldset>";
		...
		$r2 = mysql_query($query2);
				if(!$r2){
					...
					echo "<input type='text' name='titulo_curso' id='titulo' value='".$titulo."' required>";
			...
			//////acaba edición y verificación, comienza envio de datos
					...
					echo "</form><form action='registro_curso_exitoso.php' method='post' id='formulario'>";	
					echo "</fieldset><fieldset id='edicion' style='display:none;'><legend id='edicion'>Edición</legend>";
					echo "<legend id='edicion'>Titulo:</legend>";
