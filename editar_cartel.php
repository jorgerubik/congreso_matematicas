	...
	$conn = mysql_connect("$host", "$user", "$pass");
		...
		$query = "SELECT * FROM ponencias_cartel WHERE RFC = '".$rfc."'"." AND id_ponencia_cartel ='".$id_trabajo."'";
					...
					while ($row = mysql_fetch_assoc($r)){
						...
						echo"<form action='editar_cartel_confirma.php' method='post' autocomplete='on' class='forms' id='formulario'>";
					...
					//querys para verificar constancias de autores y coautores
						$query_requiere = "SELECT constancia FROM autores WHERE RFC = '".$rfc."'"." AND id_trabajo = '".$id_trabajo."'";
							 ...
							 $row_requiere3 = mysql_fetch_array($result_requiere3); 
  							 ...
  							 if ($requiere3 == 'SI') {
  							 	# code...
							 	echo "<td><input type='radio' name='requiere3' id='requiere3' value='".$requiere3."' checked>Si <input type='radio' name='requiere3' id='requiere3a' value='NO'>NO </td>";
  							 }
  							 if ($requiere3 == 'NO') {
  							 	# code...
							 ...
							 $row_requiere4 = mysql_fetch_array($result_requiere4); 
  							 ...
  							 if ($requiere4 == 'SI') {
  							 	# code...
							 	echo "<td><input type='radio' name='requiere4' id='requiere4' value='".$requiere4."' checked>Si <input type='radio' name='requiere4' id='requiere4a' value='NO'>NO </td>";
  							 }
  							 if ($requiere4 == 'NO') {
  							 	# code...
  							 	echo "<td><input type='radio' name='requiere4' id='requiere4' value='SI'>Si <input type='radio' name='requiere4' ' id='requiere4a' value='".$requiere4."' checked>NO </td>";

  							 }
  							 if ($requiere4 == '') {
  							 	# code...
   							 	echo "<td><input type='radio' name='requiere4' id='requiere4' value='SI'>Si <input type='radio' name='requiere3' id='requiere4a' value='NO'>NO </td>";
