...
//conectar con el servidor
	...
	//////////////////////////////////////////////////////////////////////////////////////
				$r = mysql_query($query);
					...
					echo "<form action = 'registro_cartel_confirmacion.php' method='post' ><fieldset>";
		...
		$r4 = mysql_query($query4);
			...
			///error		
					...
					echo "<input type='text' name='Titulo_cartel'id='titulo' value='".$titulo."' required>";
					...
					//id=autores
					echo "<td><input type='radio' name='requiere_autor' id='constancia' value='SI'>SI </td> <td><input type='radio' name='requiere' id='constancia' value='NO'>NO</td></tr>";
					}
					else{
						if (($rfc_autor_error == "")||($rfc_autor_limite == "")){
						echo "<tr><td><input type='text' name='rfc_autor' id='id_ponente1' value='".$rfc_autor."' maxlength='13'></td>";
		...
		/////////////acaba edición y verificación, comienza envio de datos
					...
					echo "</form><form action='registro_cartel_exitoso.php' method='post' id='formulario'>";
					echo "</fieldset><fieldset id='edicion' style='display:none;'><legend id='edicion'>Edición</legend>";
					echo "<legend id='edicion'>Titulo:</legend>";	
