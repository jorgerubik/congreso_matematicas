...
class PDF extends FPDF
{
    ...
    function Header() 
    {
        ...
        $this->Text(150,68,utf8_decode('Categoría:'));
        $this->Text(150,72,utf8_decode('Modalidad:'));

        //Cuerpo de la carta
        $this->Text(10,75,utf8_decode('Estimado(s):'));
        //$this->Text(10,137,utf8_decode(''),0,0,'C');
        $this->Text(10,105,utf8_decode('Tenemos el agrado de comunicarle(s) que su PONENCIA ORAL:'));
        //$this->Cell(100,170,utf8_decode(' '),0,0,'C');
        $this->Text(10,120,utf8_decode('Presentado para este congreso, ha sido ACEPTADO.'));
        $this->Text(10, 125,utf8_decode('El comité evaluador le(s) recomienda:'));
        //$this->Cell(-200,200,utf8_decode(''),0,0,'C');
        $this->Text(10,140,utf8_decode('La Ponencia será presentado el día y fecha que se le indique, en caso omiso quedara fuera de concurso.'));
        $this->Text(10,145,utf8_decode('La estructura de la ponencia la puede consultar en el menú de presentaciones de la página:'));
        $this->Text(10,150,utf8_decode('http://congresomatematicas.cuautitlan2.unam.mx'));
        $this->Text(10,155,utf8_decode('Sin más por el momento, quedamos de usted.'));
        $this->Text(10,160,utf8_decode('Atentamente'));
        $this->Text(20,165,utf8_decode('"Por mi Raza Hablará el Espíritu"'));
        $this->Text(20,170,utf8_decode('Cuautitlán Izcalli, Edo, Méx. a 10 de diciembre de 2013'));
       
        $this->Text(20,230,utf8_decode("Dr. Juan Alfonso Oaxaca Luna                                                                    Dra. María del Carmen Valderrama Bravo"));
...
// $pdf -> SetXY(10,78);  
// $pdf->MultiCell(0,3, utf8_decode($rfc), 0,'L');
$pdf ->SetXY(10,106);
