...
class PDF extends FPDF
{
    ...
    function Header() 
    {
        ...
        $this->Text(10,105,utf8_decode('Tenemos el agrado de comunicarle(s) que su CARTEL:'));
        ...
        $this->Text(10,140,utf8_decode('El Cartel será presentado el día y fecha que se le indique, en caso omiso quedara fuera de concurso.'));
        $this->Text(10,145,utf8_decode('La estructura del Cartel la puede consultar en el menú de presentaciones de la página:'));
